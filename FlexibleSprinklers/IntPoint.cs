...
namespace Shockah.FlexibleSprinklers
{
    public struct IntPoint
    {
        ...
        public static readonly IntPoint Top = new IntPoint(0, -1);
        public static readonly IntPoint Bottom = new IntPoint(0, 1);

        public static readonly ICollection<IntPoint> NeighborOffsets = new List<IntPoint>() { Left, Right, Top, Bottom };

        public int X;
        public int Y;

        public ICollection<IntPoint> Neighbors
        {
            get
            {
                var self = this;
