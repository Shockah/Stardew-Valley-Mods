...
namespace Shockah.CommonModCode
{
	...
	{
		public static void PatchVirtual(this Harmony self, MethodBase original, HarmonyMethod? prefix = null, HarmonyMethod? postfix = null, HarmonyMethod? finalizer = null)
		{
			...
			foreach (Type subtype in declaringType.Assembly.GetTypes().Where(t => t.IsAssignableTo(declaringType)))
			{
