				...
				.Do(matcher =>
				{
					return matcher
						.Find(
							...
							ILMatches.LdcI4(5).Anchor(out Guid countAnchor),
				...
				.Do(matcher =>
				{
					return matcher
						.Find(
							...
							ILMatches.LdcI4(200).Anchor(out Guid countAnchor),
							ILMatches.Call("ContainsId")
						)
						.Anchors().PointerMatcher(countAnchor)
		...
		try
		{
			return new SequenceBlockMatcher<CodeInstruction>(instructions)
				...
				.Insert(
					...
					new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(ModEntry), nameof(ParrotUpgradePerch_IsAvailable_Transpiler_ModifyRequiredMails))),
